...
namespace OpenCollar.Extensions.Logging
{
    ...
    internal sealed class OperationScope : Disposable
    {
        ...
        /// </param>
        internal OperationScope(Microsoft.Extensions.Logging.ILogger logger, Microsoft.Extensions.Logging.LogLevel beginLogLevel, Microsoft.Extensions.Logging.LogLevel endLogLevel, string scopeName, Func<string>? getAdditionalEndMessage)
        {
            ...
            {
                _logger.SafeLog(beginLogLevel, generatedMessage);
            }
        ...
        protected override void Dispose(bool disposing)
        {
            if(disposing && (_logLevel != Microsoft.Extensions.Logging.LogLevel.None))
            {
                ...
                // Record the message.
                _logger.SafeLog(_logLevel, message);
